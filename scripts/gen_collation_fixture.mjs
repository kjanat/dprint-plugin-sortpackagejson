...
const REAL_NAMES = [
  'react', 'React', 'react-dom', 'rabbit', '@types/node', '@types/react',
  '@babel/core', 'a-b', 'a_b', 'a1b', 'a.b', 'lodash', 'lodash.merge',
  'eslint', 'eslint-config-prettier', 'eslint_legacy', 'Zone.js', 'zone.js',
  '@scope/x', 'zzz', 'foo2', 'foo10', '_private', 'AWS-sdk', 'aws-sdk',
]
